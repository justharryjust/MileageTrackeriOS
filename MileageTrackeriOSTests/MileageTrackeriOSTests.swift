...
struct NotificationHelperTests {
    ...
    func weeklySummaryEmptyContent() throws {
        ...
        nm.scheduleWeeklySummary(weekKm: 0, businessCount: 0)
    ...
    func weeklySummaryWithData() throws {
        ...
        nm.scheduleWeeklySummary(weekKm: 150.5, businessCount: 3, formattedValue: "$46")
        nm.cancelWeeklySummary()
    ...
    func weeklySummaryToggleCancel() throws {
        let nm = NotificationManager()
        NotificationManager.weeklySummaryEnabled = true
        nm.scheduleWeeklySummary(weekKm: 100, businessCount: 2, formattedValue: "$20")
...
struct CloudSyncManagerConversionTests {
    ...
    func calculatorCurrencyCode() throws {
        ...
        let profile = UserProfile()
        profile.jurisdiction = .unitedKingdom
